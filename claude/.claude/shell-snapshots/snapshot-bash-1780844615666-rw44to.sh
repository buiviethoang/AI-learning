...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/home/hoangbui/.local/bin/claude
...
export PATH=/home/hoangbui/anaconda3/bin:/home/hoangbui/anaconda3/condabin:/usr/local/bin:/home/hoangbui/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/opt/spark/spark-3.5.0-bin-hadoop3/bin:/opt/spark/spark-3.5.0-bin-hadoop3/sbin:/opt/hadoop/hadoop-3.3.6/sbin:/opt/hadoop/hadoop-3.3.6/bin:/opt/spark/spark-3.5.0-bin-hadoop3/bin:/opt/spark/spark-3.5.0-bin-hadoop3/sbin:/usr/local/go/bin:/home/hoangbui/go/bin:/home/hoangbui/go/bin:/home/hoangbui/.claude/plugins/cache/claude-plugins-official/context7/c27421d77d9e/bin:/home/hoangbui/.claude/plugins/cache/claude-plugins-official/code-review/c27421d77d9e/bin:/home/hoangbui/.claude/plugins/cache/claude-plugins-official/code-simplifier/1.0.0/bin:/home/hoangbui/.claude/plugins/cache/caveman/caveman/655b7d9c5431/bin:/home/hoangbui/.claude/plugins/cache/claude-plugins-official/gopls-lsp/1.0.0/bin
